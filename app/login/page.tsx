...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await login(submissionData);
        ...
        <div className="bg-black border border-zinc-800 rounded-[32px] overflow-hidden shadow-2xl">
          <div className="p-10 pb-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-zinc-400">Log in to your Twinkle account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-zinc-600 transition h-12 placeholder:text-zinc-600"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className="w-full px-4 py-3 bg-black border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-zinc-600 transition h-12 pr-12 placeholder:text-zinc-600"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full h-12 bg-white text-black font-bold rounded-lg hover:bg-zinc-200 transition flex items-center justify-center mt-4"
              >
          ...
          <div className="bg-zinc-900/30 p-8 border-t border-zinc-800/50 text-center">
            <p className="text-sm text-zinc-400">
              New to Twinkle ?{' '}
              <Link href="/signup" className="text-white font-bold hover:underline ml-1">
                Create an account
              </Link>
            </p>
          </div>

                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-5xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <div className="bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-900 aspect-[15/8] relative rounded-2xl flex items-center justify-center">
                                        <div className="text-center p-8">
                                            <h3 className="text-2xl font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Your App Preview</h3>
                                            <p className="text-zinc-500 dark:text-zinc-400">Add your app screenshot here</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
